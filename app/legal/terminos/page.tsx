...
export const metadata = {
  title: 'Términos y Condiciones — AECOMI',
  description: 'Términos y condiciones de uso del sitio web y servicios de AECOMI.',
};
...
const sections = [
  {
    ...
    content: (
      <>
        <p>Bienvenido a AECOMI. Estos términos y condiciones rigen el acceso y uso del sitio web <strong>aecomi.com</strong> y todos los servicios relacionados ofrecidos por AECOMI, incluyendo pero no limitado a: certificaciones profesionales BIM, formación especializada, recursos técnicos y consultoría.</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>Al utilizar el sitio web de AECOMI, confirmas que:</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>AECOMI te otorga una licencia limitada, no exclusiva, no transferible y revocable para acceder y utilizar el sitio web y su contenido con fines personales y no comerciales, o para los fines específicamente autorizados en relación con nuestros servicios de certificación y formación.</p>
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Contactar con AECOMI a través de los canales proporcionados.</li>
        </ul>
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Utilizar el sitio web de manera que pueda dañar, deshabilitar, sobrecargar o deteriorar los servidores o redes de AECOMI.</li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>Todo el contenido disponible en el sitio web de AECOMI, incluyendo pero no limitado a textos, gráficos, logotipos, iconos, imágenes, clips de audio, descargas digitales, compilaciones de datos y software, es propiedad de AECOMI o de sus licenciantes y está protegido por las leyes internacionales de derechos de autor, marcas registradas y otras leyes de propiedad intelectual.</p>
        <p>La marca AECOMI, los logotipos, los nombres de certificaciones y todos los gráficos relacionados son marcas comerciales de AECOMI. No se permite el uso de estas marcas sin el consentimiento previo por escrito de AECOMI.</p>
        <p>El contenido generado por los usuarios (como testimonios, comentarios o contribuciones a foros) permanece bajo la propiedad intelectual del usuario, pero al publicarlo en nuestro sitio otorgas a AECOMI una licencia no exclusiva, mundial, libre de regalías y sublicenciable para usar, reproducir, modificar, adaptar, publicar, traducir y distribuir dicho contenido.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>El sitio web y todos los servicios de AECOMI se proporcionan <strong>"tal cual"</strong> y <strong>"según disponibilidad"</strong>, sin garantías de ningún tipo, ya sean expresas o implícitas.</p>
        <p>AECOMI no garantiza que:</p>
        ...
        <p className="mt-4">En ningún caso AECOMI será responsable por daños directos, indirectos, incidentales, especiales, consecuenciales o punitivos, incluyendo pero no limitado a: pérdida de beneficios, datos, uso, fondo de comercio u otras pérdidas intangibles, resultantes de:</p>
        <ul className="list-disc pl-5 space-y-1 mt-3">
  ...
  },
  {
    ...
    content: (
      <>
        <p>Los servicios de certificación de AECOMI están sujetos a términos y condiciones adicionales específicos que se te proporcionarán durante el proceso de solicitud.</p>
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Cumplir con el código de ética y conducta profesional de AECOMI.</li>
        </ul>
        <h3 className="text-lg font-bold text-[#333] mt-4 mb-2">Proceso de solicitud</h3>
        <p>Al solicitar una certificación, AECOMI evaluará tu elegibilidad según los criterios establecidos. Nos reservamos el derecho de rechazar cualquier solicitud que no cumpla con los requisitos mínimos, sin obligación de proporcionar una explicación detallada.</p>
        <h3 className="text-lg font-bold text-[#333] mt-4 mb-2">Cancelación y reembolsos</h3>
        <p>Las tarifas de solicitud y examen generalmente no son reembolsables una vez iniciado el proceso de evaluación. En casos excepcionales (fuerza mayor, circunstancias médicas documentadas), se puede evaluar una devolución parcial a discreción de AECOMI.</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>Para acceder a ciertos servicios de AECOMI, es posible que necesites crear una cuenta de usuario. Al hacerlo, te comprometes a:</p>
        <ul className="list-disc pl-5 space-y-2 mt-3">
          ...
          <li><strong>No transferencia:</strong> No transferir, vender o ceder tu cuenta a terceros sin autorización expresa de AECOMI.</li>
        </ul>
        <p className="mt-4">AECOMI se reserva el derecho de suspender o terminar cuentas que incumplan estos términos, que presenten información fraudulenta o que realicen actividades que consideremos perjudiciales para otros usuarios o para la organización.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>Nuestro sitio web puede contener enlaces a sitios web de terceros que no son propiedad ni están controlados por AECOMI. Estos enlaces se proporcionan únicamente para tu conveniencia e información.</p>
        <p>AECOMI no tiene control sobre el contenido, las políticas de privacidad o las prácticas de sitios web de terceros y no asume responsabilidad alguna por ellos. El acceso y uso de sitios web de terceros vinculados desde nuestro sitio es bajo tu propio riesgo.</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>AECOMI se reserva el derecho, a su entera discreción, de:</p>
        <ul className="list-disc pl-5 space-y-2 mt-3">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc pl-5 space-y-2 mt-3">
          <li><strong>Correo electrónico:</strong> <a href="mailto:legal@aecomi.com" className="text-[#0066CC] hover:underline">legal@aecomi.com</a></li>
          <li><strong>Formulario de contacto:</strong> <a href="/contact" className="text-[#0066CC] hover:underline">aecomi.com/contact</a></li>
          <li><strong>Dirección postal:</strong> AECOMI, Madrid, España</li>
        </ul>
...
export default function Page() {
  return (
    <LegalPage
      ...
      subtitle="Reglas de uso del sitio web y servicios de AECOMI"
