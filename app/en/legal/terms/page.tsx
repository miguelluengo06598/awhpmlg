...
export const metadata = {
  title: 'Terms and Conditions — AECMI',
  description: 'Terms and conditions of use of the AECMI website and services.',
};
...
const sections = [
  {
    ...
    content: (
      <>
        <p>Welcome to AECMI. These terms and conditions govern access to and use of the <strong>aecmi.com</strong> website and all related services offered by AECMI, including but not limited to: professional BIM certifications, specialized training, technical resources and consulting.</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>By using the AECMI website, you confirm that:</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>AECMI grants you a limited, non-exclusive, non-transferable and revocable license to access and use the website and its content for personal and non-commercial purposes, or for the purposes specifically authorized in relation to our certification and training services.</p>
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Contact AECMI through the provided channels.</li>
        </ul>
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Use the website in a manner that could damage, disable, overload or impair AECMI servers or networks.</li>
  ...
  },
  {
    ...
    content: (
      <>
        <p>All content available on the AECMI website, including but not limited to text, graphics, logos, icons, images, audio clips, digital downloads, data compilations and software, is the property of AECMI or its licensors and is protected by international copyright, trademark and other intellectual property laws.</p>
        <p>The AECMI brand, logos, certification names and all related graphics are trademarks of AECMI. Use of these marks without the prior written consent of AECMI is not permitted.</p>
        <p>User-generated content (such as testimonials, comments or forum contributions) remains under the intellectual property of the user, but by posting it on our site you grant AECMI a non-exclusive, worldwide, royalty-free and sublicensable license to use, reproduce, modify, adapt, publish, translate and distribute such content.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>The website and all AECMI services are provided <strong>"as is"</strong> and <strong>"as available"</strong>, without warranties of any kind, whether express or implied.</p>
        <p>AECMI does not guarantee that:</p>
        ...
        <p className="mt-4">In no event shall AECMI be liable for direct, indirect, incidental, special, consequential or punitive damages, including but not limited to: loss of profits, data, use, goodwill or other intangible losses, resulting from:</p>
        <ul className="list-disc pl-5 space-y-1 mt-3">
  ...
  },
  {
    ...
    content: (
      <>
        <p>AECMI certification services are subject to additional specific terms and conditions that will be provided to you during the application process.</p>
        ...
        <ul className="list-disc pl-5 space-y-1">
          ...
          <li>Comply with AECMI's code of ethics and professional conduct.</li>
        </ul>
        <h3 className="text-lg font-bold text-[#333] mt-4 mb-2">Application process</h3>
        <p>When applying for a certification, AECMI will evaluate your eligibility according to the established criteria. We reserve the right to reject any application that does not meet the minimum requirements, without obligation to provide a detailed explanation.</p>
        <h3 className="text-lg font-bold text-[#333] mt-4 mb-2">Cancellation and refunds</h3>
        <p>Application and examination fees are generally non-refundable once the evaluation process has begun. In exceptional cases (force majeure, documented medical circumstances), a partial refund may be evaluated at AECMI's discretion.</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>To access certain AECMI services, you may need to create a user account. By doing so, you agree to:</p>
        <ul className="list-disc pl-5 space-y-2 mt-3">
          ...
          <li><strong>No transfer:</strong> Not transfer, sell or assign your account to third parties without AECMI's express authorization.</li>
        </ul>
        <p className="mt-4">AECMI reserves the right to suspend or terminate accounts that violate these terms, present fraudulent information or engage in activities that we consider harmful to other users or to the organization.</p>
      </>
    ),
  },
  {
    ...
    content: (
      <>
        <p>Our website may contain links to third-party websites that are not owned or controlled by AECMI. These links are provided solely for your convenience and information.</p>
        <p>AECMI has no control over the content, privacy policies or practices of third-party websites and assumes no responsibility for them. Access and use of third-party websites linked from our site is at your own risk.</p>
  ...
  },
  {
    ...
    content: (
      <>
        <p>AECMI reserves the right, at its sole discretion, to:</p>
        <ul className="list-disc pl-5 space-y-2 mt-3">
  ...
  },
  {
    ...
    content: (
      <>
        ...
        <ul className="list-disc pl-5 space-y-2 mt-3">
          <li><strong>Email:</strong> <a href="mailto:legal@aecmi.com" className="text-[#0066CC] hover:underline">legal@aecmi.com</a></li>
          <li><strong>Contact form:</strong> <a href="/en/contact" className="text-[#0066CC] hover:underline">aecmi.com/contact</a></li>
          <li><strong>Postal address:</strong> AECMI, Madrid, Spain</li>
        </ul>
...
export default function Page() {
  return (
    <LegalPage
      ...
      subtitle="Rules for using the AECMI website and services"
